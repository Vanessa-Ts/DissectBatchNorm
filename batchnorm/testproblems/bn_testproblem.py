...
class BN_TestProblem(abc.ABC):
    """
        Same as DeepOBS test problems base class but with additional variable for 
        batch norm layer position.

        Args:
            batch_size (int): Batch size to use.
            position (array): Position of BN layers in the network.
        ...
        Attributes:
            ...
            _position: Position of BN layers in this network.
        ...
        """
    def __init__(self, batch_size, position, l2_reg=None):
...
class BN_WeightRegularizedTestproblem(BN_TestProblem):
...
class BN_UnregularizedTestproblem(BN_TestProblem):
