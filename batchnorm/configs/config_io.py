...
"""
This module handles typechecking+loading YAML settings for tuning
"""
...
def get_config(yaml_path, problem="cifar10_3c3d", optimizer="SGD"):
    ...
    opt_hpars = dict(OmegaConf.merge(
        OmegaConf.structured(opt_hpar_class), sett["opt_hpars"]))
